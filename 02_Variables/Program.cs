...
namespace _02_Variables
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //Console.WriteLine("***** Fiyat Llistesi *****");
            //Console.WriteLine();
            ...
            //double starawberryTotalPrice = strawberryGram * strawberryPrice;
            //double potatoTotalPrice = potatoGram * potatoPrice;
            //double tomataTotalPrice = tomatoGram * tomatoPrice;
            ...
            //Console.WriteLine("Alınan Ürün: Çilek - " + "Birim Fiyat: " + strawberryPrice +" - Gramaj: " + strawberryGram +" - Toplam Tutar: " + starawberryTotalPrice + " TL");
            //Console.WriteLine("Alınan Ürün: Patates - " + "Birim Fiyat: " + potatoPrice +" - Gramaj: " + potatoGram +" - Toplam Tutar: " + potatoTotalPrice + " TL");
            //Console.WriteLine("Alınan Ürün: Domates - " + "Birim Fiyat: " + tomatoPrice +" - Gramaj: " + tomatoGram +" - Toplam Tutar: " + tomataTotalPrice + " TL");

            //double shoppingTotalPrice = appleTotalPrice + orangeTotalPrice + starawberryTotalPrice + potatoTotalPrice + tomataTotalPrice;
